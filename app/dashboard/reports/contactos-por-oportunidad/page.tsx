...
export default function ContactosPorOportunidadPage() {
  ...
  const handleCharge = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Reporte de Contacto por oportunidad exportado exitosamente.');
    }, 1500);
  };
      ...
      <div className="glass-panel" style={{ maxWidth: '850px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '24px', boxShadow: '0 20px 40px -15px rgba(0,0,0,0.05)' }}>
        <div style={{ marginBottom: '30px', borderBottom: '1px solid #f1f5f9', paddingBottom: '20px' }}>
          <h1 style={{ fontSize: '20px', fontWeight: '800', color: '#1e293b', margin: '0 0 6px 0' }}>
            Contacto por Oportunidad
          </h1>
          <p style={{ margin: 0, fontSize: '13px', color: '#64748b' }}>
            Permite descargar un informe de los contactos de las oportunidades.
          </p>
        </div>
