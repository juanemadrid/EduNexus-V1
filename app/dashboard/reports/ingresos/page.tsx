...
export default function IngresosPage() {
  ...
  const handleCharge = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Reporte de Ingresos exportado exitosamente.');
    }, 1500);
  };
      ...
      <div className="glass-panel" style={{ maxWidth: '850px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '24px', boxShadow: '0 20px 40px -15px rgba(0,0,0,0.05)' }}>
        <div style={{ marginBottom: '30px', borderBottom: '1px solid #f1f5f9', paddingBottom: '20px' }}>
          ...
          <p style={{ margin: 0, fontSize: '13px', color: '#64748b' }}>
            Permite visualizar el detalle de los ingresos en un período o rango de fechas seleccionado.
          </p>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(180px, 220px) 1fr', gap: '20px', alignItems: 'center', marginBottom: '24px' }}>
            ...
            <div>
              ...
              >
                ...
                <option value="Detallado por Producto">Detallado por Producto</option>
                <option value="Detallado por Cuenta - Forma Pago">Detallado por Cuenta - Forma Pago</option>
              </select>
            </div>
