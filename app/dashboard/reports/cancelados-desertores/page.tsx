...
export default function CanceladosDesertoresPage() {
  ...
  const handleCharge = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Reporte Cancelados - Desertores cargado exitosamente.');
    }, 1500);
  };
      ...
      <div className="glass-panel" style={{ maxWidth: '850px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '24px', boxShadow: '0 20px 40px -15px rgba(0,0,0,0.05)' }}>
        <div style={{ marginBottom: '30px', borderBottom: '1px solid #f1f5f9', paddingBottom: '20px' }}>
          ...
          <p style={{ margin: 0, fontSize: '13px', color: '#64748b' }}>
            Permite observar los estudiantes que han cancelado su matrícula con su respectiva causa y descripción en el rango de fechas seleccionado.
          </p>
        </div>
