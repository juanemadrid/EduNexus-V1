...
export default function DocentesPendientesEvaluarPage() {
  ...
  const handleCharge = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Reporte de Docentes pendientes por evaluar el 100% cargado exitosamente.');
    }, 1500);
  };
      ...
      <div className="glass-panel" style={{ maxWidth: '850px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '24px', boxShadow: '0 20px 40px -15px rgba(0,0,0,0.05)' }}>
         <div style={{ marginBottom: '30px', borderBottom: '1px solid #f1f5f9', paddingBottom: '20px' }}>
           ...
           <p style={{ margin: 0, fontSize: '13px', color: '#64748b' }}>
             Permite generar el listado de los docentes que no han evaluado al 100% un curso en un período o rango de fechas específico.
           </p>
         </div>
                ...
                <>
                  ...
                  <div>
                    <select className="input-premium" style={{ width: '100%', height: '42px', fontSize: '14px', background: '#f8fafc', border: '1px solid #e2e8f0' }}>
                      ...
                      <option value="1">CURSO PRUEBA</option>
                    </select>
                  </div>
                </>
              )}
