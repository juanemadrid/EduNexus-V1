...
export default function PermisosPerfilesPage() {
  ...
  const handleCharge = () => {
    ...
    setTimeout(() => { 
      setIsLoading(false); 
      alert('Reporte de permisos por perfil cargado exitosamente.'); 
    }, 1500);
  };
         ...
         <div style={{ padding: '0 40px' }}>
           ...
           <div style={{ marginTop: '40px', textAlign: 'center', padding: '40px', background: '#f8fafc', borderRadius: '16px', border: '1px dashed #e2e8f0' }}>
              ...
              <p style={{ color: '#64748b', fontSize: '14px' }}>
                Visualice la matriz de permisos global configurada para cada rol o perfil del sistema.
              </p>
           </div>
         </div>
