...
export default function ConsolidadoMatriculadosSemestrePage() {
  ...
  const handleExport = () => {
    ...
    setTimeout(() => {
      ...
      alert('Reporte Consolidado de matriculados por semestre exportado a Excel.');
    }, 1500);
  };
      ...
      <div className="glass-panel" style={{ maxWidth: '850px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '24px', boxShadow: '0 20px 40px -15px rgba(0,0,0,0.05)' }}>
         <div style={{ marginBottom: '30px', borderBottom: '1px solid #f1f5f9', paddingBottom: '20px' }}>
           ...
           <p style={{ margin: 0, fontSize: '13px', color: '#64748b' }}>
             Permite exportar a un archivo de Excel la cantidad de estudiantes matriculados a un período o rango de fechas específico.
           </p>
         </div>
         ...
         <div style={{ padding: '0 40px' }}>
           <div style={{ display: 'grid', gridTemplateColumns: 'minmax(180px, 220px) 1fr', gap: '20px', alignItems: 'center', marginBottom: '24px' }}>
              ...
              <div>
                <select className="input-premium" style={{ width: '100%', height: '42px', fontSize: '14px', background: '#f8fafc', border: '1px solid #e2e8f0' }} value={form.condicion} onChange={e => handleChange('condicion', e.target.value)}>
              ...
              <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', cursor: 'pointer', color: '#475569' }}>
                   <input 
                     ...
                     name="filtro" 
                     value="Consolidado" 
                     checked={form.filtro === 'Consolidado'} 
