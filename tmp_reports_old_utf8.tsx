  ...
  return (
    <DashboardLayout>
      ...
      <ReportCategory 
        ...
        icon={BookOpen} 
        items={[
          'Inasistencias por curso', 'Fichas de matr├¡culas', 'Familiares codeudores', 
          'Asistencia detallada', 'Estad├¡stica de matr├¡culas', 'Estudiantes nuevos',
          'Hist├│rico de notas', 'Planillas de estudiantes', 'Resultados acad├®micos'
        ]} 
      />
      ...
      <ReportCategory 
        ...
        icon={DollarSign} 
        items={[
          'Cartera general', 'Ingresos detallados', 'Notas cr├®dito', 
          'Descuentos aplicados', 'Cuadro de caja', 'Proyecci├│n de recaudo'
        ]} 
      />
      ...
      <ReportCategory 
        ...
        items={[
          ...
          'Contactos por oportunidad', 'Gesti├│n de operadores'
        ]} 
      />
